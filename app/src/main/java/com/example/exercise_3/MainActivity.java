    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String selectedImage = selectedRadioButton.getText().toString();
                RadioButton radioButton1 = findViewById(R.id.radioButtonImage1);
                radioButton1.setTag("img1");
                RadioButton radioButton2 = findViewById(R.id.radioButtonImage2);
                radioButton2.setTag("img_2");
                RadioButton radioButton3 = findViewById(R.id.radioButtonImage3);
                radioButton3.setTag("img3");

                long newRowId = dbHelper.insertRecord(name, dateOfBirth, email, selectedRadioButton.getTag().toString());
        ...
        btnViewDetails.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("selectedImageTag", selectedImage);
